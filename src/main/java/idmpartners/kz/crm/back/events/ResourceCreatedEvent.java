...
public class ResourceCreatedEvent extends ModuleEvent {
    private final ResourceType resourceType;
    private final UUID resourceId;
    private final UUID userId;
    private final Object resourceData;

    public ResourceCreatedEvent(CrmModule module, ResourceType resourceType, UUID resourceId,
                                UUID userId, Object resourceData) {
        super(module, "RESOURCE_CREATED");
